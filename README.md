...
Однако, это правило не работает, если получение данных из внешних источников это единственная бизнес логика сервиса:
...
### Модели
Модель это простой объект со свойствами, не содержащий бизнес логики.
