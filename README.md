...
### TO-DO читаемость важнее быстродействия (преждевременная оптимизация)
...
TO-DO написать про разделение бизнес логики:
- каждый класс должен отвечать за одну из составляющих:
    - данные
    - логика
        - контроллер
    - представление
